      ...
      body: Stack(
        children: [
          Positioned(
            top: -100,
            right: -50,
            child: _buildGlowOrb(300, Color(0xFF00F5FF).withValues(alpha: 0.15)),
          ),
          Positioned(
            bottom: -50,
            left: -100,
            child: _buildGlowOrb(400, Color(0xFF7000FF).withValues(alpha: 0.12)),
          ),
          Positioned(
            top: 200,
            left: -150,
            child: _buildGlowOrb(300, Color(0xFF00F5FF).withValues(alpha: 0.08)),
          ),
