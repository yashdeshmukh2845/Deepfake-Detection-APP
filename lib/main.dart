...
class DeepfakeApp extends StatefulWidget {
  const DeepfakeApp({super.key});

  static final ValueNotifier<ThemeMode> themeNotifier = ValueNotifier(ThemeMode.dark);

  @override
  State<DeepfakeApp> createState() => _DeepfakeAppState();
}

class _DeepfakeAppState extends State<DeepfakeApp> {
  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder<ThemeMode>(
      valueListenable: DeepfakeApp.themeNotifier,
